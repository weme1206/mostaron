    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: const [
          ...
          _Mod('2. 角色', [
            '创建/编辑角色：头像、人设、性格、语气、背景、开场白、聊天背景。',
            '可用文字一键生成角色（含开场白），可撤销。',
          ...
          _Mod('3. 聊天', [
            ...
            '最新一轮消息下方有：重生成 / 删除 / 编辑 / 生成我的回复。',
            '输入框：回车换行，点发送键发送。',
            '顶部菜单：角色设置、聊天窗口设置、长期记忆、世界书、删除对话。',
          ]),
          _Mod('4. 群聊', [
            '创建群聊：选成员、设头像/背景/回复模式（全员/指定/自然聊天）。',
            '成员互相可见，可长按成员编辑角色，可从角色长按"创建群聊"。',
            '群聊也有模型切换、聊天窗口设置（隐藏头像会提示）、世界书、长记忆、简短对话模式。',
          ]),
          _Mod('5. 记忆', [
